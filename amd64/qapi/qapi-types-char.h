...
#if defined(CONFIG_SPICE_PROTOCOL)
typedef struct q_obj_ChardevQemuVDAgent_wrapper q_obj_ChardevQemuVDAgent_wrapper;
#endif /* defined(CONFIG_SPICE_PROTOCOL) */
...
#if defined(CONFIG_SPICE_PROTOCOL)
struct q_obj_ChardevQemuVDAgent_wrapper {
...
#endif /* defined(CONFIG_SPICE) */
#if defined(CONFIG_SPICE_PROTOCOL)
        q_obj_ChardevQemuVDAgent_wrapper qemu_vdagent;
#endif /* defined(CONFIG_SPICE_PROTOCOL) */

...
#if defined(CONFIG_SPICE_PROTOCOL)
bool visit_type_q_obj_ChardevQemuVDAgent_wrapper_members(Visitor *v, q_obj_ChardevQemuVDAgent_wrapper *obj, Error **errp)
{
...
bool visit_type_ChardevBackend_members(Visitor *v, ChardevBackend *obj, Error **errp)
{
    ...
    case CHARDEV_BACKEND_KIND_QEMU_VDAGENT:
        return visit_type_q_obj_ChardevQemuVDAgent_wrapper_members(v, &obj->u.qemu_vdagent, errp);
#endif /* defined(CONFIG_SPICE_PROTOCOL) */

...
bool visit_type_q_obj_ImageInfoSpecificRbd_wrapper_members(Visitor *v, q_obj_ImageInfoSpecificRbd_wrapper *obj, Error **errp)
{
...
bool visit_type_ImageInfoSpecific_members(Visitor *v, ImageInfoSpecific *obj, Error **errp)
{
    ...
    case IMAGE_INFO_SPECIFIC_KIND_RBD:
        return visit_type_q_obj_ImageInfoSpecificRbd_wrapper_members(v, &obj->u.rbd, errp);
    default:
        abort();
    }
    return true;

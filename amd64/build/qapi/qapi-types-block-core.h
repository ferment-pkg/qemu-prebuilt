...
typedef struct q_obj_ImageInfoSpecificRbd_wrapper q_obj_ImageInfoSpecificRbd_wrapper;
...
struct q_obj_ImageInfoSpecificRbd_wrapper {
...
struct ImageInfoSpecific {
    ...
    union { /* union tag is @type */
        ...
        q_obj_ImageInfoSpecificRbd_wrapper rbd;
    } u;
};

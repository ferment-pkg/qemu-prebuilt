...
void qmp_marshal_test_features0(QDict *args, QObject **ret, Error **errp)
{
    ...
    retval = qmp_test_features0(arg.has_fs0, arg.fs0, arg.has_fs1, arg.fs1, arg.has_fs2, arg.fs2, arg.has_fs3, arg.fs3, arg.has_fs4, arg.fs4, arg.has_cfs1, arg.cfs1, arg.has_cfs2, arg.cfs2, arg.has_cfs3, arg.cfs3, &err);
    error_propagate(errp, err);
    if (err) {
        goto out;
    }
